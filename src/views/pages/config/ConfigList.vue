...
const fetchData = async (page = 1, searchQuery = '') => {
  try {
    let url = `https://gateway.berkompeten.id/api/admin/master/config?page=${page}`;
    if (searchQuery) {
...
//   try {
//     const response = await axios.delete(`https://gateway.berkompeten.id/api/admin/master/category-lab?id=${id}`, {
//       headers: {
//         Authorization: `Bearer ${token}`,
//       },
//     });
...
<template>
  <div>
    <VCardTitle class="mb-4">Config Management</VCardTitle>
