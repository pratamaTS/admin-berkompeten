...
const fetchData = async (page = 1, searchQuery = '') => {
  try {
    let url = `https://gateway.berkompeten.id/api/admin/master/category-lab?page=${page}`;
    if (searchQuery) {
...
const createData = () => {
  ...
  router.push(`/category-lab/detail`);
};
...
<template>
  <div>
    <VCardTitle class="mb-4">Category Lab Management</VCardTitle>
